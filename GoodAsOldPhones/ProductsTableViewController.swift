...
class ProductsTableViewController: UITableViewController {
  ...
  override func viewDidLoad() {
    ...
    products = [
      ...
      Product(name: "1952 Nokia", cellImageName: "image-cell1", fullscreenImageName: "phone-fullscreen4"),
      Product(name: "1937 Samsung", cellImageName: "image-cell4", fullscreenImageName: "phone-fullscreen4"),
